...
Use the fork action below a completed assistant response to create a separate chat.
It retains the original profile and Space. The server adds a unique numbered fork
suffix to its title and preserves original message timestamps in inherited context.
