...
Global, profile, and Space dashboards remember your preferred chat mode on this device. The top-right Chat / Columns switch opens that workspace and remembers it for subsequent dashboard card clicks. Search tasks and chats from the dashboard header. Opening a chat in Columns focuses it if present or appends it to your current board, preserving the arrangement. Settled and archived chats open as references without changing their status. A return link names the dashboard you came from and restores its filters and reading position. Click **Columns** to resume your arrangement without selecting another chat.
