...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const attachmentEnvironmentUnavailable = environmentUnavailable !== null;
  useEffect(() => {
    // Cached capabilities can arrive before the connection on draft hydration.
    if (!attachmentUploadsCapabilityKnown || attachmentEnvironmentUnavailable) {
      return;
    }
    ...
    attachmentEnvironmentUnavailable,
    attachmentUploadsCapabilityKnown,
    ...
    <>
      ...
      <ProviderModelPicker
          ...
          ? {
              ...
              onToggleModel: (
                ...
                if (next.length > 1) {
                  ...
                  onProviderModelSelect(remaining.instanceId, remaining.model, remaining.options, {
                    focusComposer: false,
                  });
                }
              },
        ...
        onInstanceModelChange={(instanceId, model, options) => {
          setMultipleModelSelections(null);
          onProviderModelSelect(instanceId, model, options);
        }}
