...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.getCompactionOutput]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.skillsWrite]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsRemove]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsRestore]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.projectsInstructions]: AuthOrchestrationReadScope,
